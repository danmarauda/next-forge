...
export const POST = async (request: Request): Promise<Response> => {
  // WorkOS uses Svix for webhooks - check for WORKOS_WEBHOOK_SECRET or use WORKOS_API_KEY fallback
  const webhookSecret =
    (env as any).WORKOS_WEBHOOK_SECRET || (env as any).WORKOS_API_KEY;
