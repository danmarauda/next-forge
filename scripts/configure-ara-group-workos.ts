...
const ARA_GROUP_CONFIG = {
  ...
  branding: {
    ...
    logoUrl: "https://propertyservices.aragroup.com.au/wp-content/uploads/2022/02/ARA-Property-Services-Stacked-Logo-Mono-White.svg",
...
function recordResult(
  ...
  const icon = status === "configured" ? "✅" : status === "manual" ? "📝" : "✅";
...
async function verifyOrganization(workos: WorkOS) {
  try {
    ...
    recordResult("Organization", "manual", `Check organization: ${error instanceof Error ? error.message : "Unknown"}`);
  }
}
...
function documentBranding() {
  ...
  console.log(`    Primary Color: ${ARA_GROUP_CONFIG.branding.primaryColor} (Lime Green)`);
  console.log(`    Secondary Color: ${ARA_GROUP_CONFIG.branding.secondaryColor} (Navy Blue)`);
...
async function documentOrganizations(workos: WorkOS) {
  ...
  console.log(`    Structure: ${ARA_GROUP_CONFIG.organizationStructure === "equal" ? "All organizations treated equally" : "Hierarchical"}`);
...
function printConfigurationGuide() {
  ...
  console.log("\n1. Branding:");
  console.log(`   - Primary Color: ${ARA_GROUP_CONFIG.branding.primaryColor}`);
  console.log(`   - Secondary Color: ${ARA_GROUP_CONFIG.branding.secondaryColor}`);
  ...
  console.log(`   - Dashboard: https://dashboard.workos.com/environment_01K5K3Y79TXRCBAA52TCYZ5CCA/roles-and-permissions`);

  console.log("\n3. Organizations:");
  console.log(`   - Primary: ${ARA_GROUP_CONFIG.organizationName}`);
  console.log(`   - Domains: ${ARA_GROUP_CONFIG.organizationDomains.join(", ")}`);
  console.log(`   - Dashboard: https://dashboard.workos.com/environment_01K5K3Y79TXRCBAA52TCYZ5CCA/organizations`);
